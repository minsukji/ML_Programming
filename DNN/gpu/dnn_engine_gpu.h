...
void ForwardCuda(const float *X, const float *W, const float *B, const float *row_Vec, const int *layer_dims,
...
float ComputeCostCuda(const float *AL, const int *Y, const int n_samples, const float *W,
                      const int *W_index, const int num_layers, const float lambda,
                      float *cost, float *d_cost);

float ComputeCostSerial(const float *AL, const int *Y, const int n_samples, float *cost, float *d_cost);
